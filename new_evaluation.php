				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="row " id="ratings-field" style="display: none">
							...
							<div class="form-group">
									<label for="" class="control-label">Submission Time</label>
									<input type="radio" name="timeliness" value="on_time" required> On Time
									<input type="radio" name="timeliness" value="late"> Late
								</div>
