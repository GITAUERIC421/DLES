...
<div class="col-lg-12">
    <div class="card card-outline card-success">
        <div class="card-header">
            <!-- Commenting out the Add New Evaluation button -->
            <!--
            ...
            <table class="table tabe-hover table-bordered" id="list">
                ...
                <tbody>
                    ...
                    if ($_SESSION['login_type'] == 1) {
                        // For evaluators, show only evaluations where they are the evaluator
                        $where = " WHERE r.evaluator_id = {$_SESSION['login_id']} ";
                    } else {
                        // For employees, show only evaluations related to their employee_id
                    ...
                    ?>
                        <tr>
                            ...
                            <?php endif; ?>
                            <td><b><?php echo number_format($row['pa']) . "  Points" ?></b></td>
                            <td class="text-center">
                                <button type="button" class="btn btn-default btn-sm btn-flat border-info wave-effect text-info dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                    Action
                                </button>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item view_evaluation" href="javascript:void(0)" data-id="<?php echo $row['employee_id'] ?>">View</a>
